...
public class InjectorWindowsNativeDispatcher implements Injector
{
    public static final ClassReference CLAZZ = ClassReference.of("sun/nio/fs/WindowsNativeDispatcher");
