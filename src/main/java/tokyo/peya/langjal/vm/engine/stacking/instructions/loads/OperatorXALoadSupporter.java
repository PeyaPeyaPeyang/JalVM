...
{
    public static void execute(@NotNull VMFrame frame, @NotNull InsnNode operand,
                               @Nullable Class<? extends VMValue> type)
    {
        ...
        if (!type.isInstance(value))
            throw new IllegalOperationPanic("Expected an " + type.getSimpleName() + " but got " + value.getClass()
                                                                                                       .getSimpleName());
