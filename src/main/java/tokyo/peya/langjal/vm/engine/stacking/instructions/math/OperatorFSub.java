...
public class OperatorFSub extends AbstractInstructionOperator<InsnNode>
{
    ...
    {
        VMFloat val1 = frame.getStack().popType(VMType.of(frame, PrimitiveTypes.FLOAT));
        VMFloat val2 = frame.getStack().popType(VMType.of(frame, PrimitiveTypes.FLOAT));
        VMFloat result = val2.sub(val1);
