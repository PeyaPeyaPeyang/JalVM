    ...
    public void execute(@NotNull VMFrame frame, @NotNull InsnNode operand)
    {
        ...
        if (value2.isCategory2())
        {
            if (value1.isCategory2())
                throw PanicCreator.createIllegalOperationPanic(frame, "Cannot duplicate two category 2 values with DUP_X2");
        ...
        {
            if (value1.isCategory2())
                throw PanicCreator.createIllegalOperationPanic(frame, "Cannot duplicate category 2 value with DUP_X2");
